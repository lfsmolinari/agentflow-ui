...
export const ShellEmptyState = ({ onStart }: ShellEmptyStateProps) => (
  <main className="flex flex-1 items-center justify-center bg-bg px-10 py-12">
    <div className="flex w-full max-w-3xl flex-col items-center rounded-panel border border-border bg-panel px-10 py-16 text-center shadow-shell">
      ...
      <button
        type="button"
        onClick={onStart}
        className="focus-ring mt-8 rounded-control bg-accent px-6 py-3 text-sm font-semibold text-accentFg"
      >
        Start a new project
      </button>
    </div>
